...
var opts = {
  accepts: function (el, target, source, sibling) {
    ...
    //console.log(target.id, target.children.length, target.classList);
    //console.log(target.classList.contains("onlySingle"),  target.children.length > 0);
    if (target.classList.contains("onlySingle") && target.children.length > 0)
      return false;
...
var checkLoyalty = function(a1,a2) {
  var a = a1.firstChild.nextSibling;
  var b = a2.firstChild.nextSibling;
  console.log("QQQQ", a,b, a.dataset.org, b.dataset.org);
  if (a.dataset.org === b.dataset.org) {
    // do detach?
    $("results-area").appendChild(a);
    $("results-area").appendChild(b);
//     $(a).appendTo("results-area");
//     $(b).appendTo("results-area");    
  }
};
  
dragula([$('left-defaults'), $('answer1'), $('answer2')], opts)
.on('drop', function (el) {
  var a1 = $("answer1"), a2 = $("answer2");
  console.log(a1.childNodes);
  console.log(a2.childNodes);
  if (a1.childNodes.length == 2 && a2.childNodes.length == 2) {
    checkLoyalty(a1,a2)  
  }
});
//dragula([$('left-defaults'), $('answer1') ], opts);
//dragula([$('left-defaults'), $('answer2') ], opts);
